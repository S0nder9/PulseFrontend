            ...
            <div className="mx-4 w-full max-w-md rounded-2xl p-6 shadow-lg bg-basic-default">
                {props.type === "add" && (
                    <section className=" h-fit w-full ">
                        <div className="mb-4">
                            <h2 className="text-2xl font-bold bg-basic-default ">
                                Добавить задачу{" "}
                            </h2>
                        </div>
                        <div className="mb-6 ">
                            <p className=" text-basic-default mt-6">
                                ...
                                />
                                <textarea
                                    className="w-full mt-5 bg-basic-default"
                        ...
                        <div className="flex justify-between">
                            <button
                                className="rounded-md bg-gray-900 px-4 py-2 text-white transition-colors hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-900 focus:ring-offset-2 dark:bg-gray-600 dark:hover:bg-gray-500 dark:focus:ring-gray-600 dark:focus:ring-offset-gray-800"
                    ...
                    <>
                        <div className="mb-4">
                            <h2 className="text-2xl font-bold w-full">
                                Изменить статус на {props.current}
                            </h2>
                        </div>
                        <div className="mb-6">
