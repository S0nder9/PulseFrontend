            ...
            <section className="w-full max-w-md mx-auto p-6 md:p-8 bg-basic-default  pt-12 shadow-md rounded-2xl">
                ...
                <div className="grid gap-2">
                    ...
                    <Input
                        id="time"
                        min="0"
                        placeholder="Введите затраченное время в часах"
                        step="1  "
                        type="number"
                ...
                <Button
                    className="w-full  hover:bg-black/50"
                    onClick={sendReportClient}
                    type="button"
                >
                    Отправить
                </Button>
                {isAdded && (
                    <h1 className=" text-center">Репорт успешно отправлен</h1>
                )}
            </section>
        </div>
    );
