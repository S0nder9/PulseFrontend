...
// Измени название на Page (с большой буквы), тогда ошибки пропадут. Только потом нужно поменять роуты.
...
export function page() {
    ...
    const userId: userData = JSON.parse(
        ...
        <>
            ...
            <Card className="bg-basic-default min-h-screen ">
                <div className="flex space-x-4 bg-basic-default w-full ">
                    <CardContent className="w-full max-w-lg space-y-4">
                        <div className="space-y-2 rounded-lg  bg-basic-default mt-5">
                            ...
                            <p className="text-gray-500 dark:text-gray-400">
                                Добавьте свой проект, введите название проекта,
                                описание и выберите участников.
                            </p>
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <Textarea
                                className="min-h-[100px] text-basic-default rounded-xl"
                                id="description"
                    ...
                    <CardContent className="flex-none"></CardContent>
                </div>
                <CardFooter className="flex justify-end">
                    <Button
                        onClick={() => createProjectClient()}
