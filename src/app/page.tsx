                    ...
                    <div className="flex flex-col justify-center space-y-4">
                        <div className="space-y-2">
                            ...
                            <p className="max-w-[600px] text-gray-500 md:text-xl dark:text-gray-400">
                                Управляй своими проектами, следи за ошибками ,
                                управляй сотрудниками и работай вместе с
                                командой в одном месте.
                                <span className=" text-xl">
                                    {" "}
                                    Рабочий Пульс -это ультимативный инструмент
                        ...
                        <div className="flex w-full max-w-sm flex-col space-y-2">
                            ...
                            <p className="text-xs text-gray-500 dark:text-gray-400">
                                Зарегистрируйся для получения дальнейшей
                                информации
                            </p>
                        </div>
                    </div>
